...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sofá Novo de Novo | Higienização e Blindagem de Estofados" },
      {
        name: "description",
        content:
      ...
      },
      {
        name: "keywords",
        content:
          "higienização de sofá, limpeza de estofados, blindagem de sofá, impermeabilização, limpeza de colchão, sofá novo de novo",
      },
      {
        property: "og:title",
